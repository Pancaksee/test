  ...
  <div class="center-vh">
    <div class="container py-5">
      <div class="row text-center">
        <!-- Team item-->
        <div class="col-xl-3 card text-white bg-dark mb-3 col-sm-6 mb-5">
          <img src="/assets/img/team/nevetS.gif" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
        ...
        <!-- Team item-->
        <div class="col-xl-3 card text-white bg-dark mb-3 col-sm-6 mb-5">
          <img src="/assets/img/team/TheArcaneBrony.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
        ...
        <!-- Team item-->
        <div class="col-xl-3 card text-white bg-dark mb-3 col-sm-6 mb-5">
          <img src="/assets/img/team/greysilly.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
        ...
        <!-- Team item-->
        <div class="col-xl-3 card text-white bg-dark mb-3 col-sm-6 mb-5">
          <img src="/assets/img/team/tofik.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
        ...
        <!-- Team item-->
        <div class="col-xl-3 card text-white bg-dark mb-3 col-sm-6 mb-5">
          <img src="/assets/img/team/ChrisChrome.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
        ...
        <!-- Team item-->
        <div class="col-xl-3 card text-white bg-dark mb-3 col-sm-6 mb-5">
          <img src="/assets/img/team/3305.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
        ...
        <!-- Team item-->
        <div class="col-xl-3 card text-white bg-dark mb-3 col-sm-6 mb-5">
          <img src="/assets/img/team/Ixogamer.gif" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
        ...
        <!-- Team item-->
        <div class="col-xl-3 card text-white bg-dark mb-3 col-sm-6 mb-5">
          <img src="/assets/img/team/kylepoops.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
          <h5 class="mb-0">Kylepoops</h5><span class="small text-uppercase text-muted">Core Team Helper</span>
          <ul class="social mb-0 list-inline mt-3">
            <!-- Kylepoops, if you're reading this, DM me some stuff to put here lol -->
          </ul>
        </div>
        <!-- End-->
        ...
        <!-- Team item-->
        <div class="col-xl-3 card text-white bg-dark mb-3 col-sm-6 mb-5">
          <img src="/assets/img/team/sholomon.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
          <h5 class="mb-0">Sholomon</h5><span class="small text-uppercase text-muted">Core Team Helper</span>
          <ul class="social mb-0 list-inline mt-3">
            <!-- Sholomon, if you're reading this, DM me some stuff to put here lol -->
          </ul>
        </div>
        <!-- End-->
      </div>
