  ...
  <div class="center-vh">
    <div class="container py-5">
      <div class="row text-center">
        ...
        <!-- Team item-->
        <div class="col-xl-3 card text-white bg-dark mb-3 col-sm-6 mb-5">
          <div class="rounded shadow-sm py-5 px-4"><img src="/assets/img/team/3305.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
        ...
        <!-- Team item-->
        <div class="col-xl-3 card text-white bg-dark mb-3 col-sm-6 mb-5">
          <div class="rounded shadow-sm py-5 px-4"><img src="/assets/img/team/kylepoops.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
        ...
        <!-- Team item-->
        <div class="col-xl-3 card text-white bg-dark mb-3 col-sm-6 mb-5">
          <div class="rounded shadow-sm py-5 px-4"><img src="/assets/img/team/sholomon.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
